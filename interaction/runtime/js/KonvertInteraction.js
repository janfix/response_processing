...
define([
    ...
    'KonvertPCI/interaction/runtime/js/renderer',
    'taoQtiItem/portableLib/OAT/util/event'
], function(qtiCustomInteractionContext, $, renderer, event) {
    'use strict';

    var _typeIdentifier = 'KonvertPCI';

    var KonvertInteraction = {
        ...
        getResponse: function() {
           ...
           // return { "base" : {"string" : "The 10 long 12 answer" } }
           //return { "base" : {"directedPair" : ["a", "b"] } }
        ...
        initialize: function(id, dom, config, assetManager) {
            ...
            //Création d'un objet tableau pour vérifier la présence de la fonction prototype toXML
    ...
    qtiCustomInteractionContext.register(KonvertInteraction);

    return KonvertInteraction;
});